...
public class ModifyMode implements BlockToolMode {
    ...
    public void onUse(Block block, Point pos, Player player, PlayerSession session) {
        ...
        String currentProp = session.read(BLToolSessionData.class, BLToolSessionData.DEFAULT).currentProp();
    ...
    public void onLeftClick(Block block, Point pos, Player player, PlayerSession session) {
        ...
        final BLToolSessionData bltoolData = session.read(BLToolSessionData.class, BLToolSessionData.DEFAULT);
